                ...
                {data.participants.length === 0 ? (
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {data.participants.map(p => (
                      <div key={p.id} className="flex items-center gap-1.5 px-2 py-1 rounded font-mono text-xs" style={{ background: p.paid ? '#3D9B5C1a' : '#1C2823', border: `1px solid ${p.paid ? '#3D9B5C66' : '#2A3830'}`, boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.06), 0 4px 14px rgba(0,0,0,0.5)', color: '#8A9A90' }}>
                        <button
